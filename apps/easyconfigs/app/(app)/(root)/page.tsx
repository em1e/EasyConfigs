...
const title = "EasyConfigs - Config Generators"
const description =
  "A powerful web-based GUI tool for accurate and efficient creation of different config files for all kinds of Minecraft plugins and mods. Ideal for server owners, devs and plugin operators seeking to minimize manual errors and effort."
